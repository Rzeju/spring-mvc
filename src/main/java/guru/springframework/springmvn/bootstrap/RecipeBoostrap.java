...
public class RecipeBoostrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.getIngredients().add(new Ingredient("serrano chilies, stems and seeds removed, minced", new BigDecimal(2), eachUom));
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(2), dashUom));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("medium riped avocados, sliced", new BigDecimal(4), eachUom));
        tacosRecipe.getIngredients().add(new Ingredient("radished, thinly sliced", new BigDecimal(4), eachUom));
